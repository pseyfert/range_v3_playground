...
struct vectorextension {
    ...
    iterator rend() noexcept { return m_vector.rend(); }
    const_iterator rend() const noexcept { return m_vector.rend(); }
    iterator rbegin() noexcept { return m_vector.rbegin(); }
    const_iterator rbegin() const noexcept { return m_vector.rbegin(); }

    const_iterator cbegin() const noexcept { return m_vector.cbegin(); }
    const_iterator cend() const noexcept { return m_vector.cend(); }
    const_iterator crend() const noexcept { return m_vector.crend(); }
    const_iterator crbegin() const noexcept { return m_vector.crbegin(); }
    ...
    void reserve(size_type n) { return m_vector.reserve(n); }
    ...
    void push_back(value_type&& val) { m_vector.push_back(val); }
    void pop_back() { return m_vector.pop_back(); }
    ...
    vectorextension() : m_vector() {}
    explicit vectorextension(const allocator_type& alloc) : m_vector(alloc) {}
    ...
    vectorextension(const std::vector<T>& x) : m_vector(x) {}
    ...
    {}
    vectorextension(std::vector<T>&& x) : m_vector(std::move(x)) {}
    ...
    extendablevector<typename T::extends_t>* base() const { return m_ref; }
...
struct extendablevector {
    ...
    void swap(extendablevector& x) { m_vector.swap(x.m_vector); }
    void clear() noexcept { m_vector.clear(); }
    ...
    extendablevector() : m_vector() {}
    explicit extendablevector(const allocator_type& alloc) : m_vector(alloc)
    {}
    ...
    extendablevector(const std::vector<T>& x) : m_vector(x) {}
    extendablevector(const extendablevector& x) : m_vector(x.m_vector) {}
    ...
    extendablevector(extendablevector&& x) : m_vector(std::move(x.m_vector))
    {}
    extendablevector(std::vector<T>&& x) : m_vector(std::move(x)) {}
